...
public class S3PathRouter {
    ...
    public RouterFunction<ServerResponse> s3Routes() {
        return RouterFunctions
            ...
            .GET(OBJECT_PATH, queryParam("encryption", v -> true), objectMetadata::getObjectEncryption)
            .GET(OBJECT_PATH, queryParam("restore", v -> true), objectMetadata::getObjectRestore)
            .GET(OBJECT_PATH, queryParam("legal-hold", v -> true), objectMetadata::getObjectLegalHold)
            .GET(OBJECT_PATH, queryParam("object-lock", v -> true), objectMetadata::getObjectLockConfiguration)
