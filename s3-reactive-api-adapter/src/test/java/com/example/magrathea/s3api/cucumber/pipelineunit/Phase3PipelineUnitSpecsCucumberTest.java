...
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "(@REQ-PIPELINE-001 or @REQ-PIPELINE-003 or @REQ-PIPELINE-004 or @REQ-PIPELINE-005 or @REQ-PIPELINE-006) and @pipeline-unit and not @not-implemented")
