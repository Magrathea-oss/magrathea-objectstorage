...
@SpringBootTest(
    ...
    properties = {
        ...
        "s3.security.audit-file=target/security-audit/ep1-awscli/events.tsv",
        "s3.security.key-file=target/security-keys/ep1-awscli/master.key",
        "s3.security.encrypted-inspection-root=target/storage-engine-it/REQ-SEC-009-sse-awscli"
    }
)
@CucumberContextConfiguration
public class Ep1SecurityIdentityAwsCliCucumberConfig {
}
