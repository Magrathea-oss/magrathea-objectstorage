...
- [ ] EP-5: CI pipeline green on full gate + appendix check + docker build; offline backup/restore and first SIGTERM shutdown validation exist; DR with RTO/RPO and broader in-flight draining still pending.
