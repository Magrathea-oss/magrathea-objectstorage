...
image::../../c4/images/structurizr-Container.png[Container Diagram, width=600]
...
- **Provided Interface:** S3 REST API (36 endpoints su 111)
...
**Blackbox Description:**
Implementa le use case di bucket lifecycle, metadata (ACL, tagging), e configurazione (CORS, versioning). Contiene BucketService, gli aggregate di dominio (Bucket, BucketConfiguration, CorsConfiguration), e i port di repository.
...
image::../../c4/images/structurizr-S3ApiAdapterComponents.png[S3 API Adapter Components, width=600]
...
| `S3BucketConfigHandler` | Bucket configuration: CORS |
...
| `S3XmlResponses` | S3-compatible XML response/error DTO factory |

=== Level 2 — Component Diagram (object-store)

.C3 Component — object-store
image::../../c4/images/structurizr-ObjectStoreComponents.png[Object Store Components, width=600]
...
image::../../c4/images/structurizr-BucketManagmentComponents.png[Bucket Management Components, width=600]

| Component | Responsibility |
|---|---|
| `BucketService` | Application service: bucket lifecycle, versioning, CORS configuration |
...
image::../../c4/images/structurizr-PersistenceComponents.png[Persistence Components, width=600]
