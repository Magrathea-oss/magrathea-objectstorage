...
| `Bucket` | Domain aggregate root: bucket identity, name, region, storage class, versioning, encryption, inline Configuration. Emits ObjectStorageEvent domain events on state transitions |
