...
> - **Latest full Maven gate (2026-07-11, local sandbox — Java 25.0.3):** `mvn -B --no-transfer-progress test` at the repository root passed with BUILD SUCCESS across all 13 reactor modules. Fresh Surefire XML contains **104 reports, 1,361 discovered report entries, 1,062 executed tests/examples, 299 skipped or tag-filtered entries, 0 failures, and 0 errors**. Execution counts are distinct from the generated Gherkin inventory and shared features may be rediscovered by multiple filtered runners.
...
| Maven full test gate (all modules) | 1062 | 0 | 299 | 1361 | Latest full Maven gate (2026-07-11): `mvn -B --no-transfer-progress test` at repository root PASS / BUILD SUCCESS; all 13 reactor modules; 104 fresh Surefire XML reports aggregate 1,361 discovered tests/examples, 1,062 passed/executed, 0 failures, 0 errors, and 299 skipped/tag-filtered. |
