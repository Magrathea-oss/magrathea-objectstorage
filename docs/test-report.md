...
> - **Latest full Maven gate (2026-07-12, local sandbox — Java 25.0.3):** `mvn -B --no-transfer-progress test` at the repository root passed with BUILD SUCCESS across all 13 reactor modules. Fresh Surefire XML contains **109 reports, 1,386 discovered report entries, 1,081 executed tests/examples, 305 skipped or tag-filtered entries, 0 failures, and 0 errors**. Execution counts are distinct from the generated Gherkin inventory and shared features may be rediscovered by multiple filtered runners.
...
| Maven full test gate (all modules) | 1081 | 0 | 305 | 1386 | Latest full Maven gate (2026-07-12): `mvn -B --no-transfer-progress test` at repository root PASS / BUILD SUCCESS; all 13 reactor modules; 109 fresh Surefire XML reports aggregate 1,386 discovered tests/examples, 1,081 passed/executed, 0 failures, 0 errors, and 305 skipped/tag-filtered. |
